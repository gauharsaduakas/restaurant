...
<%
  ...
  String restaurantName = (_rStart != null && _rStart.getName() != null && !_rStart.getName().isBlank()) ? _rStart.getName() : "🎍 Ресторан";
%>
<!doctype html>
<html lang="ru">
<head>
...
<div style="min-height:100vh;display:flex;align-items:center;justify-content:center;padding:24px;">
  <div class="form-card" style="width:100%;max-width:500px;text-align:center;">
    ...
    <div style="display:flex;flex-direction:column;gap:14px;">
      <a class="btn primary full-width" href="${pageContext.request.contextPath}/login">
        🔑 Войти
      </a>

      <a class="btn ghost full-width" href="${pageContext.request.contextPath}/register">
        📝 Зарегистрироваться
      </a>
    </div>
  </div>
