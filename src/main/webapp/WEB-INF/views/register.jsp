...
<%
    Restaurant _rReg = (Restaurant) request.getAttribute("restaurant");
    String restaurantName = (_rReg != null && _rReg.getName() != null && !_rReg.getName().isBlank()) ? _rReg.getName() : "Gauhar Restaurant";
%>
<!doctype html>
<html lang="ru">
<head>
    ...
    <title>Регистрация клиента — <%= restaurantName %></title>
...
<div style="min-height:100vh;display:flex;align-items:center;justify-content:center;padding:24px;">
    <div class="form-card" style="width:100%;max-width:420px;">
        <div style="text-align:center;margin-bottom:28px;">
            ...
            <p style="color:var(--sub);font-size:13px;">Регистрация клиента</p>
        </div>
        ...
        <div style="margin-top:20px;text-align:center;color:var(--sub);font-size:13px;">
            Уже есть аккаунт?
            <a href="${pageContext.request.contextPath}/login" style="color:var(--green);text-decoration:underline;">
                Войти
            </a>
        </div>
    </div>
