...
<head>
    ...
    <title>Управление меню — Coffito Kitchen</title>
...
<div class="admin-container">
    ...
    <div class="placeholder">
        <p>📋 Функция управления меню находится в разработке</p>
        <p><a href="${pageContext.request.contextPath}/menu-items" style="color: #d4a574;">Перейти к меню</a></p>
    </div>
</div>
</body>
</html>
